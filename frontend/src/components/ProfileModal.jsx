...
export default function ProfileModal({ user, account, onClose, onSignOut, onDeleteAccount }) {
        ...
        {confirming === "delete" && (
          <div className="animate-fade-in">
            ...
            <p className="text-xs mb-3" style={{ color: "#64748B" }}>
              This permanently removes your account, research history, and any remaining credits. Active subscriptions are cancelled. This cannot be undone.
            </p>
            <div className="flex gap-3">
